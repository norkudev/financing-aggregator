...
@Component
public class SolidBankMapperImpl implements SolidBankMapper {
    ...
    public ApplicationRequest toApplicationRequest(SubmitApplication submitApplication) {
        ...
        applicationRequest.setPhone( submitApplication.phone() );
        applicationRequest.setEmail( submitApplication.email() );
        applicationRequest.setMonthlyIncome( submitApplication.monthlyIncome() );
        applicationRequest.setMonthlyExpenses( submitApplication.monthlyExpenses() );
        applicationRequest.setMaritalStatus( submitApplication.maritalStatus() );
        applicationRequest.setAgreeToBeScored( submitApplication.agreeToBeScored() );
